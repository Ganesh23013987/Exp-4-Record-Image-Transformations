...
plt.axis('off') 
```
<img width="837" height="615" alt="image" src="https://github.com/user-attachments/assets/acef30bf-eab7-4ba7-aa28-771292fef28f" />
...
plt.axis('off')
```
<img width="852" height="625" alt="image" src="https://github.com/user-attachments/assets/454e5b0d-90c0-454b-a269-26b72a0ec9e3" />
...
plt.axis('off')
```
<img width="855" height="277" alt="image" src="https://github.com/user-attachments/assets/b609ab89-e613-4614-befc-ae70a7abc021" />
...
plt.axis('off')
```
<img width="922" height="671" alt="image" src="https://github.com/user-attachments/assets/1778a004-5689-475d-84f2-4bd6d98f631e" />
...
plt.axis('off')
```
<img width="910" height="679" alt="image" src="https://github.com/user-attachments/assets/194b2260-4dde-4300-a32a-be59506b7f50" />
...
plt.axis('off')
```
<img width="826" height="606" alt="image" src="https://github.com/user-attachments/assets/10dcd1b7-5045-4f66-9539-faaa4ea40cce" />
...
plt.axis('off')
```
<img width="963" height="757" alt="image" src="https://github.com/user-attachments/assets/fca0dd9d-5f42-4764-9cf6-801a18aa775c" />
